...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/collection.vue?vue&type=template&id=151d6f42&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"category"}}),_vm._ssrNode(" <section class=\"collection section-b-space pt-0 ratio_square\"><div class=\"container\"><div class=\"row partition-collection\">"+(_vm._ssrList((_vm.items),function(item,index){return ("<div class=\"col-lg-3 col-md-6\"><div class=\"collection-block\"><div><img"+(_vm._ssrAttr("src",item.imagepath))+" alt=\"item.title\" class=\"img-fluid\"></div> <div class=\"collection-content\"><h4>"+_vm._ssrEscape(_vm._s(item.procount))+"</h4> <h3>"+_vm._ssrEscape(_vm._s(item.title))+"</h3> <p>"+_vm._ssrEscape(_vm._s(item.desc))+"</p> <a href=\"javascript:void(0)\" class=\"btn btn-outline\">shop now !</a></div></div></div>")}))+"</div></div></section> "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/page/collection.vue?vue&type=template&id=151d6f42&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/collection.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var collectionvue_type_script_lang_js_ = ({components:{Header: header1["a" /* default */],Footer: footer1["a" /* default */],Breadcrumbs: breadcrumbs["a" /* default */]},data(){return{items:[{imagepath:__webpack_require__(128),procount:'(30 Products)',title:'Fashion',desc:'Lorem Ipsum is simply dummy text of the printing and typesetting industry now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.'},{imagepath:__webpack_require__(128),procount:'(12 Products)',title:'kids',desc:'Lorem Ipsum is simply dummy text of the printing and typesetting industry now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.'},{imagepath:__webpack_require__(128),procount:'(18 Products)',title:'Shoes',desc:'Lorem Ipsum is simply dummy text of the printing and typesetting industry now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.'},{imagepath:__webpack_require__(128),procount:'(24 Products)',title:'Bags',desc:'Lorem Ipsum is simply dummy text of the printing and typesetting industry now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.'},{imagepath:__webpack_require__(128),procount:'(24 Products)',title:'Watch',desc:'Lorem Ipsum is simply dummy text of the printing and typesetting industry now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.'},{imagepath:__webpack_require__(128),procount:'(24 Products)',title:'Flower',desc:'Lorem Ipsum is simply dummy text of the printing and typesetting industry now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.'},{imagepath:__webpack_require__(128),procount:'(12 Products)',title:'Beauty',desc:'Lorem Ipsum is simply dummy text of the printing and typesetting industry now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.'},{imagepath:__webpack_require__(128),procount:'(12 Products)',title:'Jewellery',desc:'Lorem Ipsum is simply dummy text of the printing and typesetting industry now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.'}]};}});
// CONCATENATED MODULE: ./pages/page/collection.vue?vue&type=script&lang=js&
 /* harmony default export */ var page_collectionvue_type_script_lang_js_ = (collectionvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/page/collection.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  page_collectionvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
