...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/element/collection-banner.vue?vue&type=template&id=5c497778&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"Collection Element"}}),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"pb-0 ratio2_1\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row partition2\">","</div>",_vm._l((_vm.items),function(item,index){return _vm._ssrNode("<div class=\"col-md-6\">","</div>",[_c('nuxt-link',{attrs:{"to":{ path: '/collection/left-sidebar/all'}}},[_c('div',{staticClass:"collection-banner p-right text-center"},[_c('div',{staticClass:"img-part"},[_c('img',{staticClass:"img-fluid",attrs:{"src":item.imagepath,"alt":""}})]),_vm._v(" "),_c('div',{staticClass:"contain-banner"},[_c('div',[_c('h4',[_vm._v(_vm._s(item.subtitle))]),_vm._v(" "),_c('h2',[_vm._v(_vm._s(item.title))])])])])])],1)}),0)])]),_vm._ssrNode(" <section class=\"banner-goggles ratio2_3\"><div class=\"container\"><div class=\"row partition3\">"+(_vm._ssrList((_vm.items2),function(item,index){return ("<div class=\"col-md-4\"><a href=\"#\"><div class=\"collection-banner p-right text-center\"><div class=\"img-part\"><img"+(_vm._ssrAttr("src",item.imagepath))+" alt class=\"img-fluid\"></div> <div class=\"contain-banner banner-3\"><div><h4>"+_vm._ssrEscape(_vm._s(item.subtitle))+"</h4> <h2>"+_vm._ssrEscape(_vm._s(item.title))+"</h2></div></div></div></a></div>")}))+"</div></div></section> <section class=\"section-b-space\"><div class=\"container\"><div class=\"row\"><div class=\"col\"><div class=\"card\"><h5 class=\"card-header\">Classes</h5> <div class=\"card-body\"><h5>Add class with collection-banner</h5> <h5>contain-align - .text-left, .text-center, .text-right</h5> <h5>contain-position - .p-left, .p-center, .p-right</h5></div></div></div></div></div></section> "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/page/element/collection-banner.vue?vue&type=template&id=5c497778&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/element/collection-banner.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var collection_bannervue_type_script_lang_js_ = ({components:{Header: header1["a" /* default */],Footer: footer1["a" /* default */],Breadcrumbs: breadcrumbs["a" /* default */]},data(){return{items:[{imagepath:__webpack_require__(169),title:'men',subtitle:'save 30%'},{imagepath:__webpack_require__(170),title:'women',subtitle:'save 60%'}],items2:[{imagepath:__webpack_require__(48),title:'speaker',subtitle:'30% off'},{imagepath:__webpack_require__(250),title:'earplug',subtitle:'save 60%'},{imagepath:__webpack_require__(251),title:'best deal',subtitle:'save 55%'}]};}});
// CONCATENATED MODULE: ./pages/page/element/collection-banner.vue?vue&type=script&lang=js&
 /* harmony default export */ var element_collection_bannervue_type_script_lang_js_ = (collection_bannervue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/page/element/collection-banner.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  element_collection_bannervue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
//# sourceMappingURL=collection-banner.js.map