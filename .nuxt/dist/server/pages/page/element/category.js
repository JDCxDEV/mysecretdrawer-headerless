...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/element/category.vue?vue&type=template&id=3861702e&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"Category Element"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<section class=\"section-b-space border-section border-top-0\">","</section>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col\">","</div>",[_vm._ssrNode("<div class=\"slide-6 no-arrow\">","</div>",[_c('div',{directives:[{name:"swiper",rawName:"v-swiper:mySwiper",value:(_vm.swiperOption),expression:"swiperOption",arg:"mySwiper"}]},[_vm._ssrNode("<div class=\"swiper-wrapper\">"+(_vm._ssrList((_vm.items),function(item,index){return ("<div class=\"swiper-slide\"><div class=\"category-block\"><a href=\"#\"><div class=\"category-image\"><img"+(_vm._ssrAttr("src",item.img))+" alt></div></a> <div class=\"category-details\"><a href=\"#\"><h5>"+_vm._ssrEscape(_vm._s(item.title))+"</h5></a></div></div></div>")}))+"</div>")])])])])])]),_vm._ssrNode(" <section class=\"p-0 ratio2_1\"><div class=\"container-fluid\"><div class=\"row category-border\">"+(_vm._ssrList((_vm.items2),function(item,index){return ("<div class=\"col-sm-4 border-padding\"><div class=\"category-banner\"><div><img"+(_vm._ssrAttr("src",item.imagepath))+" alt class=\"img-fluid bg-img\"></div> <div class=\"category-box\"><a href=\"#\"><h2>"+_vm._ssrEscape(_vm._s(item.title))+"</h2></a></div></div></div>")}))+"</div></div></section> <div class=\"container category-button\"><section class=\"section-b-space border-section border-bottom-0\"><div class=\"row partition1\">"+(_vm._ssrList((_vm.category),function(cat,index){return ("<div class=\"col\"><a href=\"#\" class=\"btn btn-outline btn-block\">"+_vm._ssrEscape(_vm._s(cat.title))+"</a></div>")}))+"</div></section></div> <div class=\"category-bg ratio_square\"><div class=\"container-fluid p-0\"><div class=\"row order-section\"><div class=\"col-sm-4 p-0\"><a href=\"#\" class=\"image-block\"><img alt"+(_vm._ssrAttr("src",_vm.imagepath_1))+" class=\"img-fluid bg-img\"></a></div> <div class=\"col-sm-4 p-0\"><div class=\"contain-block even\"><div><h6>"+_vm._ssrEscape(_vm._s(_vm.subtitle_1))+"</h6> <a href=\"#\"><h2>"+_vm._ssrEscape(_vm._s(_vm.title_1))+"</h2></a> <a href=\"#\" class=\"btn btn-solid category-btn\">"+_vm._ssrEscape(_vm._s(_vm.offer_1))+"</a> <a href=\"#\"><h6><span>shop now</span></h6></a></div></div></div> <div class=\"col-sm-4 p-0\"><a href=\"#\" class=\"image-block\"><img alt"+(_vm._ssrAttr("src",_vm.imagepath_2))+" class=\"img-fluid bg-img\"></a></div> <div class=\"col-sm-4 p-0\"><div class=\"contain-block\"><div><h6>"+_vm._ssrEscape(_vm._s(_vm.subtitle_2))+"</h6> <a href=\"#\"><h2>"+_vm._ssrEscape(_vm._s(_vm.title_2))+"</h2></a> <a href=\"#\" class=\"btn btn-solid category-btn\">"+_vm._ssrEscape(_vm._s(_vm.offer_2))+"</a> <a href=\"#\"><h6><span>shop now</span></h6></a></div></div></div> <div class=\"col-sm-4 p-0\"><a href=\"#\" class=\"image-block even\"><img alt"+(_vm._ssrAttr("src",_vm.imagepath_3))+" class=\"img-fluid bg-img\"></a></div> <div class=\"col-sm-4 p-0\"><div class=\"contain-block\"><div><h6>"+_vm._ssrEscape(_vm._s(_vm.subtitle_3))+"</h6> <a href=\"#\"><h2>"+_vm._ssrEscape(_vm._s(_vm.title_3))+"</h2></a> <a href=\"#\" class=\"btn btn-solid category-btn\">"+_vm._ssrEscape(_vm._s(_vm.offer_3))+"</a> <a href=\"#\"><h6><span>shop now</span></h6></a></div></div></div></div></div></div> "),_vm._ssrNode("<section class=\"section-b-space ratio_portrait\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col\">","</div>",[_c('div',{directives:[{name:"swiper",rawName:"v-swiper:mySwiper1",value:(_vm.swiperOption1),expression:"swiperOption1",arg:"mySwiper1"}]},[_vm._ssrNode("<div class=\"swiper-wrapper category-m\">"+(_vm._ssrList((_vm.itemsCat),function(item,index){return ("<div class=\"swiper-slide\"><div class=\"category-wrapper\"><div><div><img"+(_vm._ssrAttr("src",item.imagepath))+" alt class=\"img-fluid bg-img\"></div> <h4>"+_vm._ssrEscape(_vm._s(item.title))+"</h4> <div>"+(_vm._s(item.description))+"</div> <a href=\"#\" class=\"btn btn-outline\">"+_vm._ssrEscape(_vm._s(item.button))+"</a></div></div></div>")}))+"</div>")])])])])]),_vm._ssrNode(" <section class=\"p-0\"><div class=\"container\"><div class=\"row background\">"+(_vm._ssrList((_vm.itemsizes),function(item,index){return ("<div class=\"col\"><a href=\"#\"><div class=\"contain-bg\"><h4>"+_vm._ssrEscape(_vm._s(item.title))+"</h4></div></a></div>")}))+"</div></div></section> "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/page/element/category.vue?vue&type=template&id=3861702e&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/element/category.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var categoryvue_type_script_lang_js_ = ({components:{Header: header1["a" /* default */],Footer: footer1["a" /* default */],Breadcrumbs: breadcrumbs["a" /* default */]},data(){return{itemsizes:[{title:'size 06'},{title:'size 07'},{title:'size 08'},{title:'size 09'},{title:'size 10'}],swiperOption1:{slidesPerView:4,freeMode:true,breakpoints:{1200:{slidesPerView:3,spaceBetween:20},991:{slidesPerView:2,spaceBetween:20},586:{slidesPerView:1,spaceBetween:20}}},itemsCat:[{imagepath:__webpack_require__(148),title:'calculator watch',description:'<ul class="category-link"><li><a href="#">Watchmaking conglomerates</a></li><li><a href="#">Breitling SA</a></li><li><a href="#">Casio watches</a></li><li><a href="#">Citizen Watch</a></li></ul>',button:'view more'},{imagepath:__webpack_require__(171),title:'Antimagnetic watch',description:'<ul class="category-link"><li><a href="#">Watchmaking conglomerates</a></li><li><a href="#">Breitling SA</a></li><li><a href="#">Casio watches</a></li><li><a href="#">Citizen Watch</a></li></ul>',button:'view more'},{imagepath:__webpack_require__(172),title:'History of watches',description:'<ul class="category-link"><li><a href="#">Watchmaking conglomerates</a></li><li><a href="#">Breitling SA</a></li><li><a href="#">Casio watches</a></li><li><a href="#">Citizen Watch</a></li></ul>',button:'view more'},{imagepath:__webpack_require__(173),title:'watch models',description:'<ul class="category-link"><li><a href="#">Watchmaking conglomerates</a></li><li><a href="#">Breitling SA</a></li><li><a href="#">Casio watches</a></li><li><a href="#">Citizen Watch</a></li></ul>',button:'view more'},{imagepath:__webpack_require__(148),title:'women watch',description:'<ul class="category-link"><li><a href="#">Watchmaking conglomerates</a></li><li><a href="#">Breitling SA</a></li><li><a href="#">Casio watches</a></li><li><a href="#">Citizen Watch</a></li></ul>',button:'view more'}],imagepath_1:__webpack_require__(158),title_1:'Tacker bag',subtitle_1:'on sale',offer_1:'save 30% off',imagepath_2:__webpack_require__(160),title_2:'Zipper storage bag',subtitle_2:'new products',offer_2:'-80% off',imagepath_3:__webpack_require__(162),title_3:'gate check bag',subtitle_3:'summer sale',offer_3:'minimum 50% off',category:[{title:'airbag'},{title:'burn bag'},{title:'briefcase'},{title:'carpet bag'},{title:'money bag'},{title:'tucker bag'}],items:[{img:__webpack_require__(164),title:'sport shoes'},{img:__webpack_require__(137),title:'casual shoes'},{img:__webpack_require__(138),title:'formal shoes'},{img:__webpack_require__(165),title:'flat'},{img:__webpack_require__(166),title:'heels'},{img:__webpack_require__(167),title:'boots'},{img:__webpack_require__(137),title:'casual shoes'},{img:__webpack_require__(138),title:'casual shoes'}],items2:[{imagepath:__webpack_require__(159),title:'men'},{imagepath:__webpack_require__(161),title:'women'},{imagepath:__webpack_require__(163),title:'kids'}],swiperOption:{dots:false,loop:true,slideSpeed:300,slidesPerView:7,breakpoints:{1367:{slidesPerView:5,loop:true},1024:{slidesPerView:4,loop:true},767:{slidesPerView:3,loop:true},480:{slidesPerView:2}}}};}});
// CONCATENATED MODULE: ./pages/page/element/category.vue?vue&type=script&lang=js&
 /* harmony default export */ var element_categoryvue_type_script_lang_js_ = (categoryvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/page/element/category.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  element_categoryvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
