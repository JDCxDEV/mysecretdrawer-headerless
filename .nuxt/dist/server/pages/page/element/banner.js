...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/element/banner.vue?vue&type=template&id=29ea2ab8&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"Banner Element"}}),_vm._ssrNode(" <section class=\"pt-0\"><div class=\"full-banner parallax text-center p-left\""+(_vm._ssrStyle(null,{ 'background-image': ("url(" + _vm.imagepath + ")") }, null))+"><img"+(_vm._ssrAttr("src",_vm.imagepath))+" alt class=\"bg-img d-none\"> <div class=\"container\"><div class=\"row\"><div class=\"col\"><div class=\"banner-contain\"><h2>"+_vm._ssrEscape(_vm._s(_vm.title))+"</h2> <h3>"+_vm._ssrEscape(_vm._s(_vm.subtitle))+"</h3> <h4>"+_vm._ssrEscape(_vm._s(_vm.text))+"</h4></div></div></div></div></div></section> "),_vm._ssrNode("<section class=\"section-b-space\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row banner-timer\""+(_vm._ssrStyle(null,{ 'background-image': 'url(' + _vm.imagepath2 + ')' }, null))+">","</div>",[_vm._ssrNode("<div class=\"col-md-6\"><div class=\"banner-text\"><h2>"+(_vm._s(_vm.offer_text))+"</h2></div></div> "),_vm._ssrNode("<div class=\"col-md-6\">","</div>",[_vm._ssrNode("<div class=\"timer-box\">","</div>",[_c('countdown',{attrs:{"date":"December 20, 2020"}})],1)])],2)])]),_vm._ssrNode(" "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/page/element/banner.vue?vue&type=template&id=29ea2ab8&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/element/banner.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var bannervue_type_script_lang_js_ = ({components:{Header: header1["a" /* default */],Footer: footer1["a" /* default */],Breadcrumbs: breadcrumbs["a" /* default */],Countdown: timer["a" /* default */]},data(){return{imagepath:__webpack_require__(126),title:'2019',subtitle:'fashion trends',text:'special offer',imagepath2:__webpack_require__(47),offer_text:'Save <span>30% off</span> Digital Watch'};}});
// CONCATENATED MODULE: ./pages/page/element/banner.vue?vue&type=script&lang=js&
 /* harmony default export */ var element_bannervue_type_script_lang_js_ = (bannervue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/page/element/banner.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  element_bannervue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
