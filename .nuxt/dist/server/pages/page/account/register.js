...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/account/register.vue?vue&type=template&id=6b3d360e&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"Register"}}),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"register-page section-b-space\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-lg-12\">","</div>",[_vm._ssrNode("<h3>"+_vm._ssrEscape(_vm._s(_vm.title))+"</h3> "),_vm._ssrNode("<div class=\"theme-card\">","</div>",[_c('ValidationObserver',{scopedSlots:_vm._u([{key:"default",fn:function(ref){
var invalid = ref.invalid;
return [_c('form',{staticClass:"theme-form",on:{"submit":function($event){$event.preventDefault();return _vm.onSubmit.apply(null, arguments)}}},[_c('div',{staticClass:"form-row"},[_c('div',{staticClass:"col-md-6"},[_c('label',{attrs:{"for":"First name"}},[_vm._v("First Name")]),_vm._v(" "),_c('ValidationProvider',{attrs:{"rules":"required","name":"First name"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.fname),expression:"fname"}],staticClass:"form-control",attrs:{"type":"text","id":"First name","placeholder":"First Name","name":"First name"},domProps:{"value":(_vm.fname)},on:{"input":function($event){if($event.target.composing){ return; }_vm.fname=$event.target.value}}}),_vm._v(" "),_c('span',{staticClass:"validate-error"},[_vm._v(_vm._s(errors[0]))])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-md-6"},[_c('label',{attrs:{"for":"lname"}},[_vm._v("Last Name")]),_vm._v(" "),_c('ValidationProvider',{attrs:{"rules":"required","name":"Last name"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.lname),expression:"lname"}],staticClass:"form-control",attrs:{"type":"text","id":"lname","placeholder":"Last Name","name":"lname"},domProps:{"value":(_vm.lname)},on:{"input":function($event){if($event.target.composing){ return; }_vm.lname=$event.target.value}}}),_vm._v(" "),_c('span',{staticClass:"validate-error"},[_vm._v(_vm._s(errors[0]))])]}}],null,true)})],1)]),_vm._v(" "),_c('div',{staticClass:"form-row"},[_c('div',{staticClass:"col-md-6"},[_c('label',{attrs:{"for":"email"}},[_vm._v("Email")]),_vm._v(" "),_c('ValidationProvider',{attrs:{"rules":"required|email","name":"Email"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.email),expression:"email"}],staticClass:"form-control",attrs:{"type":"email","id":"email","placeholder":"Email","name":"email"},domProps:{"value":(_vm.email)},on:{"input":function($event){if($event.target.composing){ return; }_vm.email=$event.target.value}}}),_vm._v(" "),_c('span',{staticClass:"validate-error"},[_vm._v(_vm._s(errors[0]))])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-md-6"},[_c('label',{attrs:{"for":"password"}},[_vm._v("Password")]),_vm._v(" "),_c('ValidationProvider',{attrs:{"rules":"required","name":"password"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.password),expression:"password"}],staticClass:"form-control",attrs:{"type":"password","id":"password","placeholder":"Enter your password","name":"password"},domProps:{"value":(_vm.password)},on:{"input":function($event){if($event.target.composing){ return; }_vm.password=$event.target.value}}}),_vm._v(" "),_c('span',{staticClass:"validate-error"},[_vm._v(_vm._s(errors[0]))])]}}],null,true)})],1),_vm._v(" "),_c('button',{staticClass:"btn btn-solid mt-2",attrs:{"type":"submit","disabled":invalid}},[_vm._v("create account")])])])]}}])})],1)],2)])])]),_vm._ssrNode(" "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/page/account/register.vue?vue&type=template&id=6b3d360e&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/account/register.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var registervue_type_script_lang_js_ = ({components:{Header: header1["a" /* default */],Footer: footer1["a" /* default */],Breadcrumbs: breadcrumbs["a" /* default */],ValidationProvider: vee_validate_full_esm["b" /* ValidationProvider */],ValidationObserver: vee_validate_full_esm["a" /* ValidationObserver */]},data(){return{title:'create account',fname:null,lname:null,email:null,password:null};},methods:{onSubmit(){console.log('Form has been submitted!');}}});
// CONCATENATED MODULE: ./pages/page/account/register.vue?vue&type=script&lang=js&
 /* harmony default export */ var account_registervue_type_script_lang_js_ = (registervue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/page/account/register.vue
