...
var add = __webpack_require__(7).default
module.exports.__inject__ = function (context) {
  add("3aa25b66", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_cart_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(626);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_cart_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_cart_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_cart_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_cart_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".color-variant a{height:20px!important;width:20px!important}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/account/cart.vue?vue&type=template&id=26f37c93&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"Cart"}}),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"cart-section section-b-space\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-sm-12\">","</div>",[(_vm.cart.length)?_vm._ssrNode("<table class=\"table cart-table table-responsive-xs\">","</table>",[_vm._ssrNode("<thead><tr class=\"table-head\"><th scope=\"col\">image</th> <th scope=\"col\">product name</th> <th scope=\"col\">price</th> <th scope=\"col\">quantity</th> <th scope=\"col\">action</th> <th scope=\"col\">total</th></tr></thead> "),_vm._l((_vm.cart),function(item,index){return _vm._ssrNode("<tbody>","</tbody>",[_vm._ssrNode("<tr>","</tr>",[_vm._ssrNode("<td>","</td>",[_c('nuxt-link',{attrs:{"to":{ path: '/product/sidebar/'+item.id}}},[_c('img',{attrs:{"src":_vm.getImgUrl(item.images[0].src),"alt":""}})])],1),_vm._ssrNode(" "),_vm._ssrNode("<td>","</td>",[_c('nuxt-link',{attrs:{"to":{ path: '/product/sidebar/'+item.id}}},[_vm._v(_vm._s(item.title))]),_vm._ssrNode(" <div class=\"mobile-cart-content row\"><div class=\"col-xs-3\"><div class=\"qty-box\"><div class=\"input-group\"><span class=\"input-group-prepend\"><button type=\"button\" data-type=\"minus\" data-field class=\"btn quantity-left-minus\"><i class=\"ti-angle-left\"></i></button></span> <input type=\"text\" name=\"quantity\""+(_vm._ssrAttr("value",(_vm.counter)))+" class=\"form-control input-number\"> <span class=\"input-group-prepend\"><button type=\"button\" data-type=\"plus\" data-field class=\"btn quantity-right-plus\"><i class=\"ti-angle-right\"></i></button></span></div></div></div> <div class=\"col-xs-3\"><h2 class=\"td-color\">"+_vm._ssrEscape(_vm._s(_vm._f("currency")(item.price * _vm.curr.curr,_vm.curr.symbol)))+"</h2></div> <div class=\"col-xs-3\"><h2 class=\"td-color\"><a href=\"#\" class=\"icon\"><i class=\"ti-close\"></i></a></h2></div></div> <div class=\"mt-2 row\"><div class=\"col-md-6\">"+_vm._ssrEscape("Size : "+_vm._s(item.size))+"</div> <div class=\"col-md-6\">\n                      Color: \n                      <span class=\"color-variant\"><li><a"+(_vm._ssrClass("mt-1",item.color))+(_vm._ssrStyle(null,{ 'background-color':  item.color }, null))+"></a></li></span></div></div>")],2),_vm._ssrNode(" <td><h2>"+_vm._ssrEscape(_vm._s(_vm._f("currency")(item.price * _vm.curr.curr,_vm.curr.symbol)))+"</h2></td> <td><div class=\"qty-box\"><div class=\"input-group\"><span class=\"input-group-prepend\"><button type=\"button\" data-type=\"minus\" data-field class=\"btn quantity-left-minus\"><i class=\"ti-angle-left\"></i></button></span> <input type=\"text\" name=\"quantity\""+(_vm._ssrAttr("disabled",item.quantity > item.stock))+(_vm._ssrAttr("value",(item.quantity)))+" class=\"form-control input-number\"> <span class=\"input-group-prepend\"><button type=\"button\" data-type=\"plus\" data-field class=\"btn quantity-right-plus\"><i class=\"ti-angle-right\"></i></button></span></div></div></td> <td><a class=\"icon\"><i class=\"ti-close\"></i></a></td> <td><h2 class=\"td-color\">"+_vm._ssrEscape(_vm._s(_vm._f("currency")((item.price * _vm.curr.curr) * item.quantity,_vm.curr.symbol)))+"</h2></td>")],2)])})],2):_vm._e(),_vm._ssrNode(" "+((_vm.cart.length)?("<table class=\"table cart-table table-responsive-md\"><tfoot><tr><td>total price :</td> <td><h2>"+_vm._ssrEscape(_vm._s(_vm._f("currency")(_vm.cartTotal * _vm.curr.curr,_vm.curr.symbol)))+"</h2></td></tr></tfoot></table>"):"<!---->")+" "),(!_vm.cart.length)?_vm._ssrNode("<div class=\"col-sm-12 empty-cart-cls text-center\">","</div>",[_vm._ssrNode("<img"+(_vm._ssrAttr("src",__webpack_require__(254)))+" alt=\"empty cart\" class=\"img-fluid\"> <h3 class=\"mt-3\"><strong>Your Cart is Empty</strong></h3> <h4 class=\"mb-3\">Add something to make me happy :)</h4> "),_vm._ssrNode("<div class=\"col-12\">","</div>",[_c('nuxt-link',{staticClass:"btn btn-solid",attrs:{"to":{ path: '/'}}},[_vm._v("continue shopping")])],1)],2):_vm._e()],2)]),_vm._ssrNode(" "),(_vm.cart.length)?_vm._ssrNode("<div class=\"row cart-buttons\">","</div>",[_vm._ssrNode("<div class=\"col-6\">","</div>",[_c('nuxt-link',{class:'btn btn-solid',attrs:{"to":{ path: '/collection/all'}}},[_vm._v("continue shopping")])],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-6\">","</div>",[_c('nuxt-link',{class:'btn btn-solid',attrs:{"to":{ path: '/page/account/checkout'}}},[_vm._v("check out")])],1)],2):_vm._e()],2)]),_vm._ssrNode(" "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/page/account/cart.vue?vue&type=template&id=26f37c93&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/account/cart.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var cartvue_type_script_lang_js_ = ({data(){return{counter:1};},components:{Header: header1["a" /* default */],Footer: footer1["a" /* default */],Breadcrumbs: breadcrumbs["a" /* default */]},computed:{...Object(external_vuex_["mapGetters"])({cart:'cart/cartItems',cartTotal:'cart/cartTotalAmount',curr:'products/changeCurrency'})},methods:{getImgUrl(path){return path.full;},removeCartItem:function(product){this.$store.dispatch('cart/removeCartItem',product);},increment(product,qty=1){this.$store.dispatch('cart/updateCartQuantity',{product:product,qty:qty});},decrement(product,qty=-1){this.$store.dispatch('cart/updateCartQuantity',{product:product,qty:qty});}}});
// CONCATENATED MODULE: ./pages/page/account/cart.vue?vue&type=script&lang=js&
 /* harmony default export */ var account_cartvue_type_script_lang_js_ = (cartvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/page/account/cart.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  account_cartvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
