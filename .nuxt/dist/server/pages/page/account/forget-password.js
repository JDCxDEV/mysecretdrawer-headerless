...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/account/forget-password.vue?vue&type=template&id=678b57f2&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"Forget Password"}}),_vm._ssrNode(" <section class=\"pwd-page section-b-space\"><div class=\"container\"><div class=\"row\"><div class=\"col-lg-6 offset-lg-3\"><h2>"+_vm._ssrEscape(_vm._s(_vm.title))+"</h2> <form method=\"post\" class=\"theme-form\">"+((_vm.errors.length)?("<div><ul class=\"validation-error mb-3\">"+(_vm._ssrList((_vm.errors),function(error,index){return ("<li>"+_vm._ssrEscape(_vm._s(error))+"</li>")}))+"</ul></div>"):"<!---->")+" <div class=\"form-row\"><div class=\"col-md-12\"><input type=\"email\" id=\"email\" placeholder=\"Enter Your Email\" name=\"email\" required=\"required\""+(_vm._ssrAttr("value",(_vm.email)))+" class=\"form-control\"></div> <input type=\"submit\" value=\"submit\" class=\"btn btn-solid\"></div></form></div></div></div></section> "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/page/account/forget-password.vue?vue&type=template&id=678b57f2&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/account/forget-password.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var forget_passwordvue_type_script_lang_js_ = ({components:{Header: header1["a" /* default */],Footer: footer1["a" /* default */],Breadcrumbs: breadcrumbs["a" /* default */]},data(){return{title:'Forget Your Password',errors:[],email:null};},methods:{checkForm:function(e){this.errors=[];if(!this.email){this.errors.push('Email required.');}else if(!this.validEmail(this.email)){this.errors.push('Valid email required.');}if(!this.errors.length)return true;e.preventDefault();},validEmail:function(email){const re=/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return re.test(email);}}});
// CONCATENATED MODULE: ./pages/page/account/forget-password.vue?vue&type=script&lang=js&
 /* harmony default export */ var account_forget_passwordvue_type_script_lang_js_ = (forget_passwordvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/page/account/forget-password.vue
