...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/account/checkout.vue?vue&type=template&id=5481c3f9&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"Checkout"}}),_vm._ssrNode(" "),_c('LoginModal',{attrs:{"openCart":_vm.showLoginModal},on:{"closeCart":_vm.closeModal}}),_vm._ssrNode(" "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/page/account/checkout.vue?vue&type=template&id=5481c3f9&

// EXTERNAL MODULE: ./node_modules/vee-validate/dist/vee-validate.full.esm.js
var vee_validate_full_esm = __webpack_require__(611);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/cart-model/cart-login-request.vue?vue&type=template&id=20040ed9&
var cart_login_requestvue_type_template_id_20040ed9_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('b-modal',{attrs:{"id":"modal-checkout","size":"lg","centered":"","title":"Add-to-cart","hide-footer":true,"hide-header":true}},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-lg-12"},[_c('div',{staticClass:"media"}),_vm._v(" "),_c('div',{staticClass:"product-section"},[_c('div',{staticClass:"col-12 product-upsell text-center"},[_c('h4',[_vm._v("Redirecting to checkout")])]),_vm._v(" "),_c('div',{staticClass:"row"})])])])])],1)}
var cart_login_requestvue_type_template_id_20040ed9_staticRenderFns = []


// CONCATENATED MODULE: ./components/cart-model/cart-login-request.vue?vue&type=template&id=20040ed9&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./components/cart-model/cart-login-request.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var cart_login_requestvue_type_script_lang_js_ = ({props:['openCart'],computed:{...Object(external_vuex_["mapState"])({currency:state=>state.products.currency}),...Object(external_vuex_["mapGetters"])({curr:'products/changeCurrency'})},methods:{// Get Image Url
...
// CONCATENATED MODULE: ./components/cart-model/cart-login-request.vue?vue&type=script&lang=js&
 /* harmony default export */ var cart_model_cart_login_requestvue_type_script_lang_js_ = (cart_login_requestvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./components/cart-model/cart-login-request.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  cart_model_cart_login_requestvue_type_script_lang_js_,
  cart_login_requestvue_type_template_id_20040ed9_render,
  cart_login_requestvue_type_template_id_20040ed9_staticRenderFns,
  false,
  null,
  null,
  "95351670"
...
/* harmony default export */ var cart_login_request = (component.exports);
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/account/checkout.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var checkoutvue_type_script_lang_js_ = ({components:{Header: header1["a" /* default */],Footer: footer1["a" /* default */],Breadcrumbs: breadcrumbs["a" /* default */],ValidationProvider: vee_validate_full_esm["b" /* ValidationProvider */],ValidationObserver: vee_validate_full_esm["a" /* ValidationObserver */],LoginModal: cart_login_request},computed:{...Object(external_vuex_["mapGetters"])({cart:'cart/cartItems',cartTotal:'cart/cartTotalAmount',curr:'products/changeCurrency',cart_key:'user/cart_key'})},data(){return{user:{firstName:'',lastName:'',phone:'',email:'',address:'',city:'',state:'',pincode:''},isLogin:false,paypal:{sandbox:'Your_Sendbox_Key'},payment:false,environment:'sandbox',button_style:{label:'checkout',size:'medium',// small | medium | large | responsive
shape:'pill',// pill | rect
color:'blue'// gold | blue | silver | black
},amtchar:'',showLoginModal:false};},mounted(){this.$bvModal.show('modal-checkout');setTimeout(()=>{window.location.replace("https://dev-msd.com/perfect-checkout?cart_key="+this.cart_key);},3000);},methods:{order(){this.isLogin=localStorage.getItem('userlogin');if(this.isLogin){this.payWithStripe();}else{this.$router.replace('/page/account/login-firebase');}},payWithStripe(){const handler=window.StripeCheckout.configure({key:'PUBLISHBLE_KEY',// 'PUBLISHBLE_KEY'
locale:'auto',closed:function(){handler.close();},token:token=>{this.$store.dispatch('products/createOrder',{product:this.cart,userDetail:this.user,token:token.id,amt:this.cartTotal});this.$router.push('/page/order-success');}});handler.open({name:'Multikart ',description:'Reach to your Dream',amount:this.cartTotal*100});},getamt(){return this.cartTotal.toString();},onPaymentComplete:function(data){this.$store.dispatch('products/createOrder',{product:this.cart,userDetail:this.user,token:data.orderID,amt:this.cartTotal});this.$router.push('/page/order-success');},onCancelled(){console.log('You cancelled a window');},onSubmit(){console.log('Form has been submitted!');},closeModal(item){this.showLoginModal=item;}}});
// CONCATENATED MODULE: ./pages/page/account/checkout.vue?vue&type=script&lang=js&
 /* harmony default export */ var account_checkoutvue_type_script_lang_js_ = (checkoutvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./pages/page/account/checkout.vue
...
var checkout_component = Object(componentNormalizer["a" /* default */])(
  account_checkoutvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
