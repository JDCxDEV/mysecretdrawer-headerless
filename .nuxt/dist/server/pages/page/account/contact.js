...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/account/contact.vue?vue&type=template&id=11aa0658&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"Contact"}}),_vm._ssrNode(" <section class=\"contact-page section-b-space\"><div class=\"container\"><div class=\"row section-b-space\"><div class=\"col-lg-7 map\"><iframe src=\"https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d1605.811957341231!2d25.45976406005396!3d36.3940974010114!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1550912388321\" allowfullscreen=\"allowfullscreen\"></iframe></div> <div class=\"col-lg-5\"><div class=\"contact-right\"><ul><li><div class=\"contact-icon\"><img"+(_vm._ssrAttr("src",_vm.phoneimage))+" alt=\"Generic placeholder image\"> <h6>Contact Us</h6></div> <div class=\"media-body\"><p>"+_vm._ssrEscape(_vm._s(_vm.phone1))+"</p> <p>"+_vm._ssrEscape(_vm._s(_vm.phone2))+"</p></div></li> <li><div class=\"contact-icon\"><i aria-hidden=\"true\" class=\"fa fa-map-marker\"></i> <h6>Address</h6></div> <div class=\"media-body\"><p>"+(_vm._s(_vm.address))+"</p></div></li> <li><div class=\"contact-icon\"><img"+(_vm._ssrAttr("src",_vm.emailimage))+" alt=\"Generic placeholder image\"> <h6>Email</h6></div> <div class=\"media-body\"><p>"+_vm._ssrEscape(_vm._s(_vm.email1))+"</p> <p>"+_vm._ssrEscape(_vm._s(_vm.email2))+"</p></div></li> <li><div class=\"contact-icon\"><i aria-hidden=\"true\" class=\"fa fa-fax\"></i> <h6>Fax</h6></div> <div class=\"media-body\"><p>"+_vm._ssrEscape(_vm._s(_vm.email1))+"</p> <p>"+_vm._ssrEscape(_vm._s(_vm.email2))+"</p></div></li></ul></div></div></div> <div class=\"row\"><div class=\"col-sm-12\"><form method=\"post\" class=\"theme-form\">"+((_vm.errors.length)?("<div><ul class=\"validation-error mb-3\">"+(_vm._ssrList((_vm.errors),function(error,index){return ("<li>"+_vm._ssrEscape(_vm._s(error))+"</li>")}))+"</ul></div>"):"<!---->")+" <div class=\"form-row\"><div class=\"col-md-6\"><label for=\"fname\">First Name</label> <input type=\"text\" id=\"fname\" placeholder=\"First Name\" name=\"fname\" required=\"required\""+(_vm._ssrAttr("value",(_vm.fname)))+" class=\"form-control\"></div> <div class=\"col-md-6\"><label for=\"lname\">Last Name</label> <input type=\"text\" id=\"lname\" placeholder=\"Last Name\" name=\"lname\" required=\"required\""+(_vm._ssrAttr("value",(_vm.lname)))+" class=\"form-control\"></div> <div class=\"col-md-6\"><label for=\"phone\">Phone number</label> <input type=\"tel\" id=\"phone\" placeholder=\"Enter your number\" name=\"phone\" required=\"required\""+(_vm._ssrAttr("value",(_vm.phone)))+" class=\"form-control\"></div> <div class=\"col-md-6\"><label for=\"email\">Email</label> <input type=\"text\" id=\"email\" placeholder=\"Email\" name=\"email\" required=\"required\""+(_vm._ssrAttr("value",(_vm.email)))+" class=\"form-control\"></div> <div class=\"col-md-12\"><label for=\"message\">Write Your Message</label> <textarea placeholder=\"Write Your Message\" id=\"message\" name=\"message\" rows=\"6\" class=\"form-control\">"+_vm._ssrEscape(_vm._s(_vm.message))+"</textarea></div> <div class=\"col-md-12\"><input type=\"submit\" value=\"Send Your Message\" class=\"btn btn-solid\"></div></div></form></div></div></div></section> "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/page/account/contact.vue?vue&type=template&id=11aa0658&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/account/contact.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var contactvue_type_script_lang_js_ = ({components:{Header: header1["a" /* default */],Footer: footer1["a" /* default */],Breadcrumbs: breadcrumbs["a" /* default */]},data(){return{phoneimage:__webpack_require__(261),emailimage:__webpack_require__(255),phone1:'+91 123 - 456 - 7890',phone2:'+86 163 - 451 - 7894',address:'ABC Complex,Near xyz, New York <br /> USA 123456',email1:'Support@Shopcart.com',email2:'info@shopcart.com',errors:[],fname:null,lname:null,email:null,phone:null,message:null};},methods:{checkForm:function(e){this.errors=[];if(!this.fname){this.errors.push('First name required.');}if(!this.lname){this.errors.push('Last name required.');}if(!this.email){this.errors.push('Email required.');}else if(!this.validEmail(this.email)){this.errors.push('Valid email required.');}if(!this.phone){this.errors.push('Phone Number required.');}if(!this.message){this.errors.push('Message required.');}if(!this.errors.length)return true;e.preventDefault();},validEmail:function(email){const re=/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return re.test(email);}}});
// CONCATENATED MODULE: ./pages/page/account/contact.vue?vue&type=script&lang=js&
 /* harmony default export */ var account_contactvue_type_script_lang_js_ = (contactvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/page/account/contact.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  account_contactvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
