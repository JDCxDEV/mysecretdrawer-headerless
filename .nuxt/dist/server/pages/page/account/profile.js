...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/account/profile.vue?vue&type=template&id=1d5189e2&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"Profile"}}),_vm._ssrNode(" <section class=\"contact-page register-page\"><div class=\"container\"><div class=\"row\"><div class=\"col-sm-12\"><h3>"+_vm._ssrEscape(_vm._s(_vm.title1))+"</h3> <form method=\"post\" class=\"theme-form\">"+((_vm.errors.length)?("<div><ul class=\"validation-error mb-3\">"+(_vm._ssrList((_vm.errors),function(error,index){return ("<li>"+_vm._ssrEscape(_vm._s(error))+"</li>")}))+"</ul></div>"):"<!---->")+" <div class=\"form-row\"><div class=\"col-md-6\"><label for=\"fname\">First Name</label> <input type=\"text\" id=\"fname\" placeholder=\"First Name\" name=\"fname\" required=\"required\""+(_vm._ssrAttr("value",(_vm.fname)))+" class=\"form-control\"></div> <div class=\"col-md-6\"><label for=\"lname\">Last Name</label> <input type=\"text\" id=\"lname\" placeholder=\"Last Name\" name=\"lname\" required=\"required\""+(_vm._ssrAttr("value",(_vm.lname)))+" class=\"form-control\"></div> <div class=\"col-md-6\"><label for=\"phone\">Phone number</label> <input type=\"tel\" id=\"phone\" placeholder=\"Enter your number\" name=\"phone\" required=\"required\""+(_vm._ssrAttr("value",(_vm.phone)))+" class=\"form-control\"></div> <div class=\"col-md-6\"><label for=\"email\">Email</label> <input type=\"text\" id=\"email\" placeholder=\"Email\" name=\"email\" required=\"required\""+(_vm._ssrAttr("value",(_vm.email)))+" class=\"form-control\"></div> <div class=\"col-md-12\"><label for=\"message\">Write Your Message</label> <textarea placeholder=\"Write Your Message\" id=\"message\" name=\"message\" rows=\"6\" class=\"form-control\">"+_vm._ssrEscape(_vm._s(_vm.message))+"</textarea></div> <div class=\"col-md-12\"><input type=\"submit\" value=\"Save\" class=\"btn btn-solid\"></div></div></form></div></div></div></section> <section class=\"contact-page register-page section-b-space\"><div class=\"container\"><div class=\"row\"><div class=\"col-sm-12\"><h3>"+_vm._ssrEscape(_vm._s(_vm.title2))+"</h3> <form method=\"post\" class=\"theme-form\"><div class=\"form-row\"><div class=\"col-md-6\"><label for=\"name\">flat / plot</label> <input type=\"text\" id=\"home-ploat\" placeholder=\"company name\" required=\"required\" class=\"form-control\"></div> <div class=\"col-md-6\"><label for=\"name\">Address *</label> <input type=\"text\" id=\"address-two\" placeholder=\"Address\" required=\"required\" class=\"form-control\"></div> <div class=\"col-md-6\"><label for=\"email\">Zip Code *</label> <input type=\"text\" id=\"zip-code\" placeholder=\"zip-code\" required=\"required\" class=\"form-control\"></div> <div class=\"col-md-6 select_input\"><label for=\"review\">Country *</label> <select size=\"1\" class=\"form-control\"><option value=\"India\">India</option> <option value=\"UAE\">UAE</option> <option value=\"U.K\">U.K</option> <option value=\"US\">US</option></select></div> <div class=\"col-md-6\"><label for=\"review\">City *</label> <input type=\"text\" id=\"city\" placeholder=\"City\" required=\"required\" class=\"form-control\"></div> <div class=\"col-md-6\"><label for=\"review\">Region/State *</label> <input type=\"text\" id=\"region-state\" placeholder=\"Region/state\" required=\"required\" class=\"form-control\"></div> <div class=\"col-md-12\"><button type=\"submit\" class=\"btn btn-sm btn-solid\">Save setting</button></div></div></form></div></div></div></section> "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/page/account/profile.vue?vue&type=template&id=1d5189e2&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/account/profile.vue?vue&type=script&lang=js&
//
//
//
//
