...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/review.vue?vue&type=template&id=9fb17c5c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"Review"}}),_vm._ssrNode(" <section class=\"section-b-space blog-detail-page review-page\"><div class=\"container\"><div class=\"row\"><div class=\"col-sm-12\"><ul class=\"comment-section\">"+(_vm._ssrList((_vm.items),function(item,index){return ("<li><div class=\"media\"><img"+(_vm._ssrAttr("src",item.imagepath))+" alt=\"item.name\"> <div class=\"media-body\"><h6>"+_vm._ssrEscape("\n                    "+_vm._s(item.name)+"\n                    ")+"<span>"+_vm._ssrEscape("( "+_vm._s(item.datetime)+" )")+"</span></h6> <p>"+_vm._ssrEscape(_vm._s(item.desc))+"</p> <ul class=\"comnt-sec\"><li><a href=\"#\"><i aria-hidden=\"true\" class=\"fa fa-thumbs-o-up\"></i> <span>(14)</span></a></li> <li><a href=\"#\"><div class=\"unlike\"><i aria-hidden=\"true\" class=\"fa fa-thumbs-o-down\"></i>(2)\n                        </div></a></li></ul></div></div></li>")}))+"</ul></div></div></div></section> "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/page/review.vue?vue&type=template&id=9fb17c5c&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/review.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var reviewvue_type_script_lang_js_ = ({components:{Header: header1["a" /* default */],Footer: footer1["a" /* default */],Breadcrumbs: breadcrumbs["a" /* default */]},data(){return{items:[{imagepath:__webpack_require__(174),name:'Mark jacno',datetime:' 12 Jannuary 2020 At 1:30AM',desc:'Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis fringilla bibendum at at leo. Proin molestie ac nisi eu laoreet. Integer faucibus enim nec ullamcorper tempor. Aenean nec felis dui. Integer tristique odio mi, in volutpat metus posuere eu. Aenean suscipit ipsum nunc, id volutpat lorem hendrerit ac. Sed id elit quam. In ac mauris arcu. Praesent eget lectus sit amet diam vestibulum varius. Suspendisse dignissim mattis leo, nec facilisis erat tempor quis. Vestibulum eu vestibulum ex.'},{imagepath:__webpack_require__(153),name:'john dio',datetime:' 23 December 2019 At 5:10PM',desc:'Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis fringilla bibendum at at leo. Proin molestie ac nisi eu laoreet. Integer faucibus enim nec ullamcorper tempor. Aenean nec felis dui. Integer tristique odio mi, in volutpat metus posuere eu. Aenean suscipit ipsum nunc, id volutpat lorem hendrerit ac. Sed id elit quam. In ac mauris arcu. Praesent eget lectus sit amet diam vestibulum varius. Suspendisse dignissim mattis leo, nec facilisis erat tempor quis. Vestibulum eu vestibulum ex.'},{imagepath:__webpack_require__(154),name:'poul carry',datetime:' 31 March 2020 At 12:19PM',desc:'Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis fringilla bibendum at at leo. Proin molestie ac nisi eu laoreet. Integer faucibus enim nec ullamcorper tempor. Aenean nec felis dui. Integer tristique odio mi, in volutpat metus posuere eu. Aenean suscipit ipsum nunc, id volutpat lorem hendrerit ac. Sed id elit quam. In ac mauris arcu. Praesent eget lectus sit amet diam vestibulum varius. Suspendisse dignissim mattis leo, nec facilisis erat tempor quis. Vestibulum eu vestibulum ex.'}]};}});
// CONCATENATED MODULE: ./pages/page/review.vue?vue&type=script&lang=js&
 /* harmony default export */ var page_reviewvue_type_script_lang_js_ = (reviewvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/page/review.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  page_reviewvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
