...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/portfolio/masonary-fullwidth.vue?vue&type=template&id=7684292c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"Mesonary Fullwidth Portfolio"}}),_vm._ssrNode(" <section class=\"filter-section\"><div class=\"container-fluid\"><div class=\"row\"><div class=\"col-12\"><div class=\"title1\"><h2 class=\"title-inner1\">portfolio</h2></div> <div class=\"filter-container isotopeFilters\"><ul class=\"list-inline filter\"><li"+(_vm._ssrClass(null,{ active: _vm.isActive('all') }))+"><a href=\"javascript:void(0)\">All</a></li> <li"+(_vm._ssrClass(null,{ active: _vm.isActive('fashion') }))+"><a href=\"javascript:void(0)\">Fashion</a></li> <li"+(_vm._ssrClass(null,{ active: _vm.isActive('bags') }))+"><a href=\"javascript:void(0)\">Bags</a></li> <li"+(_vm._ssrClass(null,{ active: _vm.isActive('shoes') }))+"><a href=\"javascript:void(0)\">Shoes</a></li> <li"+(_vm._ssrClass(null,{ active: _vm.isActive('watch') }))+"><a href=\"javascript:void(0)\">Watch</a></li></ul></div></div></div></div></section> "),_vm._ssrNode("<section class=\"portfolio-section portfolio-padding pt-0 port-col zoom-gallery\">","</section>",[_vm._ssrNode("<div class=\"container-fluid\">","</div>",[_c('no-ssr',[_c('div',{directives:[{name:"masonry",rawName:"v-masonry"}],staticClass:"masonry-container isotopeContainer row",attrs:{"transition-duration":"3s","item-selector":".item"}},_vm._l((_vm.filteredImages),function(item,index){return _c('div',{directives:[{name:"masonry-tile",rawName:"v-masonry-tile"}],key:index,staticClass:"col-sm-2 isotopeSelector item"},[_c('div',{staticClass:"overlay"},[_c('div',{staticClass:"border-portfolio"},[_c('a',{attrs:{"href":"javascript:void(0)"}},[_c('div',{staticClass:"overlay-background"}),_vm._v(" "),_c('img',{staticClass:"img-fluid",attrs:{"src":item.imagepath}})])])])])}),0)])],1)]),_vm._ssrNode(" "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/page/portfolio/masonary-fullwidth.vue?vue&type=template&id=7684292c&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/portfolio/masonary-fullwidth.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var masonary_fullwidthvue_type_script_lang_js_ = ({components:{Header: header1["a" /* default */],Footer: footer1["a" /* default */],Breadcrumbs: breadcrumbs["a" /* default */],'no-ssr':external_vue_no_ssr_default.a},data(){return{galleryFilter:'all',imagearray:[{id:1,title:'Slim Fit Cotton Shirt',alt:'established',filter:'fashion',imagepath:__webpack_require__(140)},{id:2,title:'trim dress',alt:'readable',filter:'shoes',imagepath:__webpack_require__(141)},{id:3,title:'trim dress',alt:'readable',filter:'shoes',imagepath:__webpack_require__(142)},{id:4,title:'trim dress',alt:'readable',filter:'bags',imagepath:__webpack_require__(143)},{id:5,title:'trim dress',alt:'readable',filter:'bags',imagepath:__webpack_require__(144)},{id:6,title:'trim dress',alt:'readable',filter:'bags',imagepath:__webpack_require__(145)},{id:7,title:'trim dress',alt:'readable',filter:'bags',imagepath:__webpack_require__(146)},{id:8,title:'trim dress',alt:'readable',filter:'watch',imagepath:__webpack_require__(147)}]};},computed:{filteredImages:function(){if(this.galleryFilter==='all'){return this.imagearray;}else{return this.imagearray.filter(data=>data.filter===this.galleryFilter);}}},mounted(){if(typeof this.$redrawVueMasonry==='function'){this.$redrawVueMasonry();}},methods:{isActive:function(menuItem){return this.galleryFilter===menuItem;},updateFilter(filterName){this.galleryFilter=filterName;}}});
// CONCATENATED MODULE: ./pages/page/portfolio/masonary-fullwidth.vue?vue&type=script&lang=js&
 /* harmony default export */ var portfolio_masonary_fullwidthvue_type_script_lang_js_ = (masonary_fullwidthvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/page/portfolio/masonary-fullwidth.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  portfolio_masonary_fullwidthvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var masonary_fullwidth = __webpack_exports__["default"] = (component.exports);

/***/ })

};;
//# sourceMappingURL=masonary-fullwidth.js.map