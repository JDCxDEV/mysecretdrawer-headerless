...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/portfolio/portfolio-4-col.vue?vue&type=template&id=a4f43516&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"Portfolio gallery"}}),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"portfolio-section grid-portfolio ratio2_3 portfolio-padding\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div align=\"center\" id=\"form1\"><button data-filter=\"all\""+(_vm._ssrClass("filter-button project_button",{ active: _vm.isActive('all') }))+">All</button> <button data-filter=\"fashion\""+(_vm._ssrClass("filter-button project_button",{ active: _vm.isActive('fashion') }))+">Fashion</button> <button data-filter=\"bags\""+(_vm._ssrClass("filter-button project_button",{ active: _vm.isActive('bags') }))+">Bags</button> <button data-filter=\"shoes\""+(_vm._ssrClass("filter-button project_button",{ active: _vm.isActive('shoes') }))+">Shoes</button> <button data-filter=\"watch\""+(_vm._ssrClass("filter-button project_button",{ active: _vm.isActive('watch') }))+">Watch</button></div> "),_vm._ssrNode("<div class=\"row zoom-gallery\">","</div>",[_vm._l((_vm.filteredImages),function(item,index){return _vm._ssrNode("<div class=\"isotopeSelector filter fashion col-sm-3\">","</div>",[_vm._ssrNode("<div class=\"overlay\">","</div>",[_vm._ssrNode("<div class=\"border-portfolio\">","</div>",[_vm._ssrNode("<a href=\"javascript:void(0)\">","</a>",[_vm._ssrNode("<div class=\"overlay-background\"><i aria-hidden=\"true\" class=\"fa fa-plus\"></i></div> "),_c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:(item.src),expression:"item.src"}],staticClass:"img-fluid"},[])],2)])])])}),_vm._ssrNode(" "),_c('LightBox',{ref:"lightbox",attrs:{"images":_vm.filteredImages,"show-caption":false,"show-light-box":false}})],2)],2)]),_vm._ssrNode(" "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/page/portfolio/portfolio-4-col.vue?vue&type=template&id=a4f43516&

// EXTERNAL MODULE: external "vue-image-lightbox"
var external_vue_image_lightbox_ = __webpack_require__(100);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/portfolio/portfolio-4-col.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var portfolio_4_colvue_type_script_lang_js_ = ({components:{Header: header1["a" /* default */],Footer: footer1["a" /* default */],Breadcrumbs: breadcrumbs["a" /* default */],LightBox: external_vue_image_lightbox_default.a},data(){return{galleryFilter:'all',images:[{id:1,title:'Slim Fit Cotton Shirt',alt:'established',filter:'fashion',thumb:__webpack_require__(129),src:__webpack_require__(129)},{id:2,title:'trim dress',alt:'readable',filter:'shoes',thumb:__webpack_require__(130),src:__webpack_require__(130)},{id:3,title:'trim dress',alt:'readable',filter:'shoes',thumb:__webpack_require__(131),src:__webpack_require__(131)},{id:4,title:'trim dress',alt:'readable',filter:'bags',thumb:__webpack_require__(132),src:__webpack_require__(132)},{id:5,title:'trim dress',alt:'readable',filter:'bags',thumb:__webpack_require__(133),src:__webpack_require__(133)},{id:6,title:'trim dress',alt:'readable',filter:'bags',thumb:__webpack_require__(134),src:__webpack_require__(134)},{id:7,title:'trim dress',alt:'readable',filter:'bags',thumb:__webpack_require__(135),src:__webpack_require__(135)},{id:8,title:'trim dress',alt:'readable',filter:'watch',thumb:__webpack_require__(136),src:__webpack_require__(136)}]};},computed:{filteredImages:function(){if(this.galleryFilter==='all'){return this.images;}else{return this.images.filter(data=>data.filter===this.galleryFilter);}}},methods:{isActive:function(menuItem){return this.galleryFilter===menuItem;},updateFilter(filterName){this.galleryFilter=filterName;},openGallery(index){this.$refs.lightbox.showImage(index);}}});
// CONCATENATED MODULE: ./pages/page/portfolio/portfolio-4-col.vue?vue&type=script&lang=js&
 /* harmony default export */ var portfolio_portfolio_4_colvue_type_script_lang_js_ = (portfolio_4_colvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/page/portfolio/portfolio-4-col.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  portfolio_portfolio_4_colvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var portfolio_4_col = __webpack_exports__["default"] = (component.exports);

/***/ })

};;
//# sourceMappingURL=portfolio-4-col.js.map