...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/search.vue?vue&type=template&id=3940dfc2&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"search"}}),_vm._ssrNode(" <section class=\"authentication-page section-b-space\"><div class=\"container\"><section class=\"search-block\"><div class=\"container\"><div class=\"row\"><div class=\"col-lg-6 offset-lg-3\"><form class=\"form-header\"><div class=\"input-group\"><input type=\"text\" placeholder=\"Search Products.....\""+(_vm._ssrAttr("value",(_vm.searchString)))+" class=\"form-control\"></div></form></div></div></div></section></div></section> "),(_vm.searchItems.length)?_vm._ssrNode("<section class=\"section-b-space ratio_asos pt-0\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row search-product\">","</div>",_vm._l((_vm.searchItems),function(product,index){return _vm._ssrNode("<div class=\"col-xl-2 col-md-4 col-sm-6\">","</div>",[_vm._ssrNode("<div class=\"product-box\">","</div>",[_vm._ssrNode(_vm._ssrEscape("\n            "+_vm._s(product.title)+"\n                            ")),_c('productBox1',{attrs:{"product":product,"index":index}})],2)])}),0)])]):_vm._e(),_vm._ssrNode(" "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/page/search.vue?vue&type=template&id=3940dfc2&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/search.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var searchvue_type_script_lang_js_ = ({components:{Header: header1["a" /* default */],Footer: footer1["a" /* default */],Breadcrumbs: breadcrumbs["a" /* default */]},data(){return{searchString:''};},computed:{...Object(external_vuex_["mapState"])({searchItems:state=>state.products.searchProduct})},methods:{searchProduct(){this.$store.dispatch('products/searchProduct',this.searchString);}}});
// CONCATENATED MODULE: ./pages/page/search.vue?vue&type=script&lang=js&
 /* harmony default export */ var page_searchvue_type_script_lang_js_ = (searchvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/page/search.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  page_searchvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
