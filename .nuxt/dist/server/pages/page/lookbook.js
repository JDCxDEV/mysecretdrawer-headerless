...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/lookbook.vue?vue&type=template&id=31ce984b&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"lookbook"}}),_vm._ssrNode(" <section class=\"lookbook section-b-space ratio_square\"><div class=\"container\"><div class=\"row\">"+(_vm._ssrList((_vm.items),function(item,index){return ("<div class=\"col-md-6\"><div class=\"lookbook-block\"><div><img"+(_vm._ssrAttr("src",item.imagepath))+" alt class=\"img-fluid\"></div> <div class=\"lookbook-dot\"><span>1</span> <a href=\"#\"><div class=\"dot-showbox\"><img"+(_vm._ssrAttr("src",item.pro1image))+" alt class=\"img-fluid\"> <div class=\"dot-info\"><h5 class=\"title\">"+_vm._ssrEscape(_vm._s(item.pro1title))+"</h5> <h5>"+_vm._ssrEscape(_vm._s(item.pro1price))+"</h5></div></div></a></div> <div class=\"lookbook-dot dot2\"><span>2</span> <a href=\"#\"><div class=\"dot-showbox\"><img"+(_vm._ssrAttr("src",item.pro2image))+" alt class=\"img-fluid\"> <div class=\"dot-info\"><h5 class=\"title\">"+_vm._ssrEscape(_vm._s(item.pro2title))+"</h5> <h5>"+_vm._ssrEscape(_vm._s(item.pro2price))+"</h5></div></div></a></div></div></div>")}))+"</div></div></section> "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/page/lookbook.vue?vue&type=template&id=31ce984b&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/lookbook.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var lookbookvue_type_script_lang_js_ = ({components:{Header: header1["a" /* default */],Footer: footer1["a" /* default */],Breadcrumbs: breadcrumbs["a" /* default */]},data(){return{items:[{imagepath:__webpack_require__(262),pro1image:__webpack_require__(156),pro1title:'Trim dress',pro1price:'$220.00',pro1link:'/home',pro2image:__webpack_require__(156),pro2title:'crop top',pro2price:'$695.00',pro2link:'/home'},{imagepath:__webpack_require__(263),pro1image:__webpack_require__(156),pro1title:'boho tops',pro1price:'$446.00',pro1link:'/home',pro2image:__webpack_require__(156),pro2title:'fitted dress',pro2price:'$235.00',pro2link:'/home'}]};}});
// CONCATENATED MODULE: ./pages/page/lookbook.vue?vue&type=script&lang=js&
 /* harmony default export */ var page_lookbookvue_type_script_lang_js_ = (lookbookvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/page/lookbook.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  page_lookbookvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
