...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/about.vue?vue&type=template&id=09e786d2&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"About"}}),_vm._ssrNode(" <section class=\"about-page section-b-space\"><div class=\"container\"><div class=\"row\"><div class=\"col-lg-12\"><div class=\"banner-section\"><img"+(_vm._ssrAttr("src",_vm.aboutbanner))+" alt class=\"img-fluid\"></div></div> <div class=\"col-sm-12\"><h4>"+_vm._ssrEscape(_vm._s(_vm.aboutTitle))+"</h4> <p>"+_vm._ssrEscape(_vm._s(_vm.aboutText))+"</p></div></div></div></section> "),_vm._ssrNode("<section class=\"testimonial small-section\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-sm-12\">","</div>",[_c('div',{directives:[{name:"swiper",rawName:"v-swiper:mySwiper",value:(_vm.swiperOption),expression:"swiperOption",arg:"mySwiper"}]},[_vm._ssrNode("<div class=\"swiper-wrapper testimonial-slider\">"+(_vm._ssrList((_vm.items),function(item,index){return ("<div class=\"swiper-slide\"><div class=\"media\"><div class=\"text-center\"><img"+(_vm._ssrAttr("src",item.imagepath))+" alt=\"#\"> <h5>"+_vm._ssrEscape(_vm._s(item.name))+"</h5> <h6>"+_vm._ssrEscape(_vm._s(item.role))+"</h6></div> <div class=\"media-body\"><p>"+_vm._ssrEscape(_vm._s(item.decs))+"</p></div></div></div>")}))+"</div>")])])])])]),_vm._ssrNode(" "),_vm._ssrNode("<section id=\"team\" class=\"team section-b-space ratio_asos\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-sm-12\">","</div>",[_vm._ssrNode("<h2>Our Team</h2> "),_c('div',{directives:[{name:"swiper",rawName:"v-swiper:mySwiper2",value:(_vm.swiperOption2),expression:"swiperOption2",arg:"mySwiper2"}]},[_vm._ssrNode("<div class=\"swiper-wrapper\">"+(_vm._ssrList((_vm.teams),function(team,index){return ("<div class=\"swiper-slide\"><div><div><img"+(_vm._ssrAttr("src",team.imagepath))+" alt class=\"img-fluid\"></div> <h4>"+_vm._ssrEscape(_vm._s(team.name))+"</h4> <h6>"+_vm._ssrEscape(_vm._s(team.post))+"</h6></div></div>")}))+"</div>")])],2)])])]),_vm._ssrNode(" "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/page/about.vue?vue&type=template&id=09e786d2&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/page/about.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var aboutvue_type_script_lang_js_ = ({components:{Header: header1["a" /* default */],Footer: footer1["a" /* default */],Breadcrumbs: breadcrumbs["a" /* default */]},data(){return{swiperOption:{slidesPerView:2,spaceBetween:20,breakpoints:{991:{slidesPerView:1,spaceBetween:20}}},swiperOption2:{slidesPerView:4,spaceBetween:20,breakpoints:{1199:{slidesPerView:3,spaceBetween:20},991:{slidesPerView:2,spaceBetween:20},420:{slidesPerView:1,spaceBetween:20}},navigation:{nextEl:'.swiper-button-next',prevEl:'.swiper-button-prev'}},items:[{imagepath:__webpack_require__(153),name:'Mark Jecno',role:'designer',decs:'you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings.'},{imagepath:__webpack_require__(154),name:'Amy Molive',role:'tester',decs:'you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings.'}],teams:[{imagepath:__webpack_require__(265),name:'Hileri Keol',post:'chairman'},{imagepath:__webpack_require__(266),name:'Peter Pants',post:'business executive'},{imagepath:__webpack_require__(267),name:'john dio',post:'project manager'},{imagepath:__webpack_require__(268),name:'Petey Cruiser',post:'web developer'}],aboutbanner:__webpack_require__(249),aboutTitle:'Sed Ut Perspiciatis Unde Omnis Iste Natus Error Sit Voluptatem Accusantium Doloremque Laudantium',aboutText:'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium On the other hand.We denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain. These cases are perfectly simple and easy to distinguish. In a free hour. when our power of choice is untrammelled and when nothing prevents our being able to do what we like best. every pleasure is to be welcomed and every pain avoided. But in certain circumstances and owing to the claims of duty or the obligations of business it will frequently occur that pleasures have to be repudiated and annoyances accepted. The wise man therefore always holds in these matters to this principle of selection he rejects pleasures to secure other greater pleasures or else he endures pains to avoid worse pains.'};}});
// CONCATENATED MODULE: ./pages/page/about.vue?vue&type=script&lang=js&
 /* harmony default export */ var page_aboutvue_type_script_lang_js_ = (aboutvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/page/about.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  page_aboutvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
