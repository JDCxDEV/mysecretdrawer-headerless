...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/_id.vue?vue&type=template&id=09e6acf2&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('Breadcrumbs',{attrs:{"title":"Blog"}}),_vm._ssrNode(" <section class=\"blog-detail-page section-b-space ratio2_3\"><div class=\"container\"><div class=\"row\"><div class=\"col-sm-12 blog-detail\"><div class=\"container\"><div class=\"row\"><div class=\"col-sm-2 blog-detail\"></div> <div class=\"col-sm-8 blog-detail\"><img"+(_vm._ssrAttr("src",_vm.blog.image))+" alt=\"blog\" class=\"img-fluid\"></div></div></div> <h3>"+_vm._ssrEscape(_vm._s(_vm.blog.display_title))+"</h3> <ul class=\"post-social\"><li>"+_vm._ssrEscape(_vm._s(_vm.blog.date))+"</li> <li>"+_vm._ssrEscape("Posted By : "+_vm._s(_vm.blog.author_name))+"</li> <li><i class=\"fa fa-comments\"></i>"+_vm._ssrEscape("  Comment(s) "+_vm._s(_vm.blog.comment_count)+"\n            ")+"</li></ul> <div>"+(_vm._s(_vm.blog.content.rendered))+"</div></div></div> <div class=\"row section-b-space\" style=\"display: none;\"><div class=\"col-sm-12\"><ul class=\"comment-section\"><li><div class=\"media\"><img"+(_vm._ssrAttr("src",__webpack_require__(174)))+" alt=\"Generic placeholder image\"> <div class=\"media-body\"><h6>\n                    Mark Jecno\n                    <span>( 12 Jannuary 2018 at 1:30AM )</span></h6> <p>Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis fringilla bibendum at at leo. Proin molestie ac nisi eu laoreet. Integer faucibus enim nec ullamcorper tempor. Aenean nec felis dui. Integer tristique odio mi, in volutpat metus posuere eu. Aenean suscipit ipsum nunc, id volutpat lorem hendrerit ac. Sed id elit quam. In ac mauris arcu. Praesent eget lectus sit amet diam vestibulum varius. Suspendisse dignissim mattis leo, nec facilisis erat tempor quis. Vestibulum eu vestibulum ex.</p></div></div></li> <li><div class=\"media\"><img"+(_vm._ssrAttr("src",__webpack_require__(153)))+" alt=\"Generic placeholder image\"> <div class=\"media-body\"><h6>\n                    Mark Jecno\n                    <span>( 12 Jannuary 2018 at 1:30AM )</span></h6> <p>Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis fringilla bibendum at at leo. Proin molestie ac nisi eu laoreet. Integer faucibus enim nec ullamcorper tempor. Aenean nec felis dui. Integer tristique odio mi, in volutpat metus posuere eu. Aenean suscipit ipsum nunc, id volutpat lorem hendrerit ac. Sed id elit quam. In ac mauris arcu. Praesent eget lectus sit amet diam vestibulum varius. Suspendisse dignissim mattis leo, nec facilisis erat tempor quis. Vestibulum eu vestibulum ex.</p></div></div></li> <li><div class=\"media\"><img"+(_vm._ssrAttr("src",__webpack_require__(154)))+" alt=\"Generic placeholder image\"> <div class=\"media-body\"><h6>\n                    Mark Jecno\n                    <span>( 12 Jannuary 2018 at 1:30AM )</span></h6> <p>Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis fringilla bibendum at at leo. Proin molestie ac nisi eu laoreet. Integer faucibus enim nec ullamcorper tempor. Aenean nec felis dui. Integer tristique odio mi, in volutpat metus posuere eu. Aenean suscipit ipsum nunc, id volutpat lorem hendrerit ac. Sed id elit quam. In ac mauris arcu. Praesent eget lectus sit amet diam vestibulum varius. Suspendisse dignissim mattis leo, nec facilisis erat tempor quis. Vestibulum eu vestibulum ex.</p></div></div></li></ul></div></div> <div class=\"row blog-contact\" style=\"display: none;\"><div class=\"col-sm-12\"><h2>Leave Your Comment</h2> <form class=\"theme-form\"><div class=\"form-row\"><div class=\"col-md-12\"><label for=\"name\">Name</label> <input type=\"text\" id=\"name\" placeholder=\"Enter Your name\" required=\"required\" class=\"form-control\"></div> <div class=\"col-md-12\"><label for=\"email\">Email</label> <input type=\"text\" id=\"email\" placeholder=\"Email\" required=\"required\" class=\"form-control\"></div> <div class=\"col-md-12\"><label for=\"exampleFormControlTextarea1\">Comment</label> <textarea placeholder=\"Write Your Comment\" id=\"exampleFormControlTextarea1\" rows=\"6\" class=\"form-control\"></textarea></div> <div class=\"col-md-12\"><button type=\"submit\" class=\"btn btn-solid\">Post Comment</button></div></div></form></div></div></div></section> "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/blog/_id.vue?vue&type=template&id=09e6acf2&
...
//
//
/* harmony default export */ var _idvue_type_script_lang_js_ = ({components:{Header: header1["a" /* default */],Breadcrumbs: breadcrumbs["a" /* default */],Footer: footer1["a" /* default */]},computed:Object(external_vuex_["mapState"])({current:state=>state.blog.current}),data(){return{blog:{content:{}}};},async mounted(){let params={params:{per_page:30,slug:this.$route.params.id},type:'single'};this.$store.dispatch('blog/fetchBlogs',params).then(()=>{let blog=[];blog.push(this.current);this.fetchCompeteData(blog);});},methods:{async fetchCompeteData(current_blogs){let blog={};await Promise.all(current_blogs.map(item=>external_axios_default.a.get(item.image_link).then(response=>{item.image=response.data.guid.rendered;item.thumbnail=response.data.media_details.sizes.thumbnail.source_url;}).then(()=>{external_axios_default.a.get(item.author_link).then(response=>{item.author_name=response.data.name;}).then(()=>{external_axios_default.a.get(item.replies_link).then(response=>{item.comment_count=response.data.length;blog=item;console.log(item);this.blog=blog;});});})));}}});
